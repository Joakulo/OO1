...
public class SistemaDeAlquileres {
	...
	public Propiedad registrarPropiedad(String nombre, String descripcion, double precio, String direccion, Usuario propietario, IPoliticaDeCancelacion politica) {
		Propiedad prop = new Propiedad(nombre, descripcion, precio, direccion, propietario, politica);
	...
	public double calcularMontoAReembolsar(Alquiler reserva, LocalDate fechaTentativa) {
		return reserva.calcularMontoAReembolsar(fechaTentativa);
	}
}
